<div class="row">
  <div class="col-md-12">
    ...
    <div class="card">
      <div class="card-body">
        <form action="<?= base_url('pembelian/edit_pembelian/' . $this->uri->segment(3)) ?>" method="POST">
                  ...
                  <table class="table table-borderless table-striped table-hover">
                    ...
                    <?php $i = 1; foreach ($form_detail as $d) { ?>
                      <tr id="row<?= $i ?>">
                        ...
                        <td class="text-center" id="textgrd-<?= $i ?>"><?= generate_form($d[7]) . $d[7]['value'] ?></td>
