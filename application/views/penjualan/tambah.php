...
function hitungTotal(){
  ...
  var grandtotal = (diskonTipe == 'nominal') ? (total - diskon) : (total * (100 - diskon)/100);
  $('input[name="subtotal_all"]').val(total);
  $('input[name="grand_total_all"]').val(grandtotal);
}

$('input[name="is_new_pelanggan"]').change(function(){
  var checked = this.checked;
  $('select[name="id_pelanggan"]').attr('disabled', checked);
  $('input[name="nama_pelanggan"]').attr('disabled', !checked);
  $('input[name="is_new_alamat"]').attr('disabled', checked);
  $('select[name="id_alamat_pelanggan"]').attr('disabled', checked);
  $('textarea[name="alamat_lengkap"]').attr('disabled', !checked);
  $('select[name="id_provinsi"]').attr('disabled', !checked);
  $('select[name="id_kota"]').attr('disabled', !checked);
  $('select[name="id_kecamatan"]').attr('disabled', !checked);
  $('select[name="id_kelurahan"]').attr('disabled', !checked);
  if ($('input[name="is_new_alamat"]').is(':checked')) $('input[name="is_new_alamat"]').prop('checked', false);
});

$('input[name="is_new_alamat"]').change(function() {
  var checked = this.checked;
  $('select[name="id_alamat_pelanggan"]').attr('disabled', checked);
  $('textarea[name="alamat_lengkap"]').attr('disabled', !checked);
  $('select[name="id_provinsi"]').attr('disabled', !checked);
